...
- Grade: E.
- Topics included crystal structures, electronic structures, lattice vibrations,
...
- This period represents the primary professional activity between earlier
  academic/R&D work and the 2026 return to formal academic coursework through
...
- Led research and software development for an augmented reality training
  platform focused on industrial training and workforce qualification.
- Designed and implemented software components for augmented reality training
  scenarios.
- Conducted applied research in augmented reality, human-computer interaction,
  computer vision, accessibility, and industrial training methods.
- Coordinated technical activities, milestone planning, documentation, internal
  validation, and technical presentations to Dell Technologies stakeholders.
...
- Developed software components for an augmented reality learning object used in
  ...
  learners.
- Supported design and refinement of the augmented reality learning object,
  user-study preparation, and analysis of experimental results.
- Contributed to research activities in accessibility, human-computer
  interaction, distance education, wearable devices, and augmented reality.
...
- Implemented C++ diagnostic routines and supported automated hardware
  validation.
- Investigated, reproduced, and fixed software defects, maintaining
...
- Worked on a virtual firearms training simulator combining interactive video,
  3D computer graphics, laser-based shot capture, adapted hardware, and
...
- Contributed to debugging, testing, validation, demonstrations, and project
  presentations.
- Public references document the project context, FUNCAP support, UFC
  participation, and EXPOSEC 2012 demonstration.
...
- Completed a 102-hour internship at StyleWiki Corporation, a South Korean
  company developing a mobile fashion application.
- Certificate confirms dates, workload, and completion.
...
- Supported academic and social integration of incoming Computer Science
  students.
- Acted as a communication link between student groups, faculty advisors, and
  course coordination.
...
- Supported Semana Zero orientation activities for incoming students.
- Helped organize academic and scientific activities, including an early
  organized student excursion to a scientific event.
