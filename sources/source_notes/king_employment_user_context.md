...
- This is a user-provided context note, not primary employment evidence.
- Add primary evidence if available before using this as a formal external claim:
  role history, employment verification, reference letter, CV export, LinkedIn
  export, or redacted HR/payroll record.
