...
| Lenovo Diagnostics / LDiag | Source note, scanned recommendation letter, and user-confirmed period | Usable as a draft with caveats; period corrected to 2014-2016; FCPC report and Lenovo manual still missing from `sources/` |
...
| E029 | `sources/source_notes/king_employment_user_context.md` | User-provided context note | King professional software development experience, 2019 start year, and role evolution | Evidence is self-reported; add primary employment evidence |
