...
- Lenovo Diagnostics participation was corrected to 2014-2016 based on
  user-provided clarification. Add primary evidence for the exact period when
  available.
...
- King employment is recorded as starting in 2019 based on user-provided
  clarification. Treat it as important professional context, especially for
  explaining the recent focus on industry work, but add primary employment
  evidence before final external use.
